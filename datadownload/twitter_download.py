...
delta_days=3#after inital load, every time this run is to load up to 1 days of data
...
#Get twitter account's summary
#Total tweets, followers_count, friends count
...
def get_tweets_from_business(business):
    ...
    for _ in range(twitter_search_limit):
        ...
        try:
            ...
            print "Key Error, No more result"
            break
...
for business in allBusiness:
    ...
    insert_business_summary(business[0],tweetscount,followingcount, followerscount[0], todayString)
...
for business_str in allBusiness:
    ...
    #save tweets data from business
